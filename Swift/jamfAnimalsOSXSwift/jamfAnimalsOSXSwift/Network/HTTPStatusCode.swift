...
enum HTTPStatusCode: Int, Error {
    ...
    enum ResponseType: Error, LocalizedError {

        /// - informational: Provisional response, check the Status-Line and optional headers.
        case informational

        /// - success: Action requested by the client was received, understood, accepted, and processed successfully.
        case success

        /// - redirection: Client must take additional action to complete the request.
        case redirection

        /// - clientError: Client seems to have erred.
        case clientError

        /// - serverError: Server failed to fulfill an apparently valid request.
        case serverError

        /// - undefined: Status code cannot be resolved.
        case undefined

        var errorDescription: String? {
            switch self {
            case .informational:
                return "Provisional response, check the Status-Line and optional headers."

            case .success:
            return "Action requested by the client was received, understood, accepted, and processed successfully."

            case .redirection:
                return "Client must take additional action to complete the request."

            case .clientError:
                return "Client seems to have erred."

            case .serverError:
                return "Server failed to fulfill an apparently valid request."

            case .undefined:
                return "Status code cannot be resolved."
            }
        }
    }
